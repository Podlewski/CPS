...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Cel zadania}
Celem cwiczenia jest zapoznanie sie z operacjami transformacji sygnalów dyskretnychprzy u¿yciu wybranych metod.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% WSTEP TEORETYCZNY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
W ramach cwiczenia nale¿alo dodac mo¿liwosc odczytu i zapisu sygnalów o wartosciach zespolonych, umo¿liwic rysowanie wykresów sygnalów dyskretnych o wartosciach zespolonych w postaci dwóch wykresów o wspólnej dziedzinie ulo¿onych jeden nad drugim. Przyjeto, ¿e sygnaly zespolone beda tylko wynikiem transformacji Fouriera, a co za tym idzie beda prezentowac funkcje w dziedzinie czestotliwosci. Dostepne mialy byc tak¿e dwa atrybuty prezentacji wykresu:

\begin{itemize}
	\item (W1) - górny   wykres   prezentuje   czesc   rzeczywista   amplitudy   w   funkcji czestotliwosci, a wykres dolny czesc urojona,
	\item (W2) - górny wykres prezentuje modul liczby zespolonej, a dolny argument liczbywfunkcji czestotliwosci
\end{itemize}

Ponadto, zaimplementowalismy nastepujace transormacje sygnalów:
\begin{itemize}
...
\begin{figure}[H]
	...
	\caption{Parametry, które przyjmowac bedzie wykorzystana przez nas funkcja w eksperymentach.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Odwrócona szybka tranformacja Fouriera.}
\end{figure}
